...
public class Encomienda extends Envio {
    ...
    public Encomienda(Persona destinatario, Persona remitente, int precio, String codigoRastreo, ArrayList<Sucursal> sucursales, Cartero cartero, String tipoEmpaquetado) {
